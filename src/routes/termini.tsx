...
export const Route = createFileRoute("/termini")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.andreamuti.com/termini" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Termini e Condizioni — Andrea Muti" },
      { name: "twitter:description", content: "Termini di utilizzo del sito." },
    ],
    links: [{ rel: "canonical", href: "https://www.andreamuti.com/termini" }],
  }),
